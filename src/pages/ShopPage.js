...
const ShopPage = (container) => {
                ...
                <div class="card-inner">
                    ...
                    <div class="card-actions">
                        <div class="primary-action">
                            <button
                                class="action-button purchase-button ${canAfford ? '' : 'disabled'} ${isPurchasing
                                    ? 'purchasing'
                                    : ''}"
    ...
    const handlePurchase = async (e) => {
        ...
        try {
            ...
            const cardData = state.unlockedCards.find(
                (card) => card.name === cardName && card.type === cardType && card.rarity === cardRarity
            );
